...
VelocityLayer::VelocityLayer ()
{
    ...
    addAndMakeVisible (upperSlider = new Slider ("PeakSlider"));
    ...
    addAndMakeVisible (lowerSlider = new Slider ("FactorSlider"));
...
//==============================================================================
void VelocityLayer::paint (Graphics& g)
{
...
void VelocityLayer::buttonClicked (Button* buttonThatWasClicked)
{
...
void VelocityLayer::sliderValueChanged (Slider* sliderThatWasMoved)
{
    ...
    {
        //[UserSliderCode_peakSlider] -- add your slider handling code here..
        //[/UserSliderCode_peakSlider]
    }
...
void VelocityLayer::comboBoxChanged (ComboBox* comboBoxThatHasChanged)
{
...
TabbedComponent& VelocityLayer::getSoundsList()
{
	return *soundsList;
}
//[/MiscUserCode]
...
<JUCER_COMPONENT documentType="Component" className="VelocityLayer" componentName=""
                 parentClasses="public Component" constructorParams="Drum&amp; drum"
                 variableInitialisers="parentDrum(drum)" snapPixels="8" snapActive="1"
  ...
  <LABEL name="LowerLabel" id="3a0d358b87a75664" memberName="lowerLabel"
         ...
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="15" kerning="0" bold="0" italic="0" justification="33"/>
  <SLIDER name="PeakSlider" id="464797bc256eed32" memberName="peakSlider"
          ...
          needsCallback="1"/>
  <SLIDER name="FactorSlider" id="3306f108b75b71c4" memberName="factorSlider"
