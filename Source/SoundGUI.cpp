...
SoundGUI::SoundGUI ()
{
    ...
    deleteSoundButton->setColour (TextButton::buttonColourId, Colour (0xffa82b2b));
...
//==============================================================================
void SoundGUI::paint (Graphics& g)
{
...
void SoundGUI::buttonClicked (Button* buttonThatWasClicked)
{
...
<JUCER_COMPONENT documentType="Component" className="SoundGUI" componentName=""
                 parentClasses="public Component" constructorParams="" variableInitialisers=""
                 snapPixels="8" snapActive="1" snapShown="1" overlayOpacity="0.330"
                 fixedSize="1" initialWidth="568" initialHeight="360">
