...
Drum::Drum ()
{
...

	{
		...
		velocityLayers->setTabBarDepth(40);
...
void Drum::comboBoxChanged (ComboBox* comboBoxThatHasChanged)
{
...
TabbedComponent& Drum::getVelocities()
{
...
<JUCER_COMPONENT documentType="Component" className="Drum" componentName="" parentClasses="public Component"
                 constructorParams="AdxAudioProcessorEditor&amp; editorRef" variableInitialisers="editor(editorRef)"
